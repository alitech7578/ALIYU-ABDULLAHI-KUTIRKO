                 ...
                 <div className="w-full pl-1 space-y-0.5 text-left">
                     {visibleFields.includes('fullName') && (
                        <div className="mb-1">
                            ...
                            <h2 className="text-[12px] font-black text-slate-900 uppercase leading-none tracking-tight">
                                {student.surname}
                            </h2>
                     ...
                     <div className="space-y-0.5">
                        {visibleFields.includes('registrationNumber') && (
                            <div className="flex items-baseline gap-1">
                                ...
                                <span className="text-[9px] font-bold text-slate-900 uppercase tracking-tight">{student.registrationNumber}</span>
                            </div>
                        )}
                        {visibleFields.includes('department') && (
                            <div className="flex items-baseline gap-1">
                                 ...
                                 <span className="text-[8px] font-bold text-slate-900 uppercase tracking-tight leading-tight">{student.department}</span>
                            </div>
                        )}
                         {visibleFields.includes('school') && (
                            <div className="flex items-baseline gap-1">
                                 ...
                                 <span className="text-[8px] font-bold text-slate-900 uppercase tracking-tight leading-tight">{student.school}</span>
                            </div>
                        )}
                         {visibleFields.includes('expirationDate') && student.expirationDate && (
                            <div className="flex items-baseline gap-1">
                                 ...
                                 <span className="text-[8px] font-bold text-slate-900 uppercase tracking-tight">{formatExpirationDate(student.expirationDate)}</span>
                            </div>
                        )}
                     </div>
                 </div>
