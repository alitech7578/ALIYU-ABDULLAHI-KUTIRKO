...
const BulkStudentIDPrint: React.FC<BulkStudentIDPrintProps> = ({ students, onClose, companyName, companyLogo, companyEmail, companyAddress, companyWebsite }) => {
  ...
  return (
    <div className="fixed inset-0 bg-brand-primary z-50 overflow-y-auto">
        ...
        <main className="p-4 sm:p-8 bg-gray-300 print:bg-white">
            <div className="grid grid-cols-1 gap-8 print:grid-cols-1 print:gap-4">
                {students.map(student => (
                   <div key={student.id} className="mx-auto my-4 break-inside-avoid page-break">
