...
const StudentIDCardBack: React.FC<StudentIDCardBackProps> = ({ student, companyName, companyLogo, companyWebsite, provostSignature }) => {
  ...
  return (
    <div
      className="w-[512px] h-[320px] bg-white rounded-xl shadow-lg p-0 overflow-hidden flex flex-col items-center justify-between font-sans text-black"
    ...
    >
      ...
      <main className="flex-grow flex flex-row items-center text-center px-4 py-2 w-full justify-around">
        <div className="flex-1">
            ...
            <p className="text-[10px] font-medium text-black" style={{ color: '#000000' }}>This card is the property of</p>
            <h2 className="text-lg font-bold mt-1 text-black uppercase tracking-wide" style={{ color: '#000000' }}>
              {renderCompanyName(companyName)}
            </h2>

            <p className="text-[10px] mt-3 text-black" style={{ color: '#000000' }}>
        ...
        <div className="flex flex-col items-center w-48 flex-shrink-0">
            ...
            <div className="w-full border-t border-black mt-1" style={{ borderColor: '#000000' }}></div>
            <p className="text-[10px] mt-1 text-black font-medium" style={{ color: '#000000' }}>Provost Signature</p>
        </div>


        {/* QR Code */}
        <div title="Scan to save contact details (vCard)" className="cursor-help flex-1">
          <div className="p-1.5 bg-white border border-gray-100 rounded-lg shadow-md inline-block">
